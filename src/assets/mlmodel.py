...
def matriculadosPosgrado():
    ...
    predictionDataframe = pd.DataFrame({"PERIODO": [
        ...
        '2025-1', '2025-2' ],                
        "Label":[
    prediction20091['Label'][0],
    prediction20097['Label'][0],
    prediction20101['Label'][0],
    prediction20107['Label'][0],
    prediction20111['Label'][0],
    prediction20117['Label'][0],
    prediction20121['Label'][0],
    prediction20127['Label'][0],

    prediction20131['Label'][0],
    prediction20137['Label'][0],
    prediction20141['Label'][0],
    prediction20147['Label'][0],
    prediction20151['Label'][0],
    prediction20157['Label'][0],
    prediction20161['Label'][0],
    prediction20167['Label'][0],
    prediction20171['Label'][0],
    prediction20177['Label'][0],
    prediction20181['Label'][0],
    prediction20187['Label'][0],
    prediction20191['Label'][0],
    prediction20197['Label'][0],

    prediction20201['Label'][0],
    prediction20207['Label'][0],
    prediction20211['Label'][0],
    prediction20217['Label'][0],
    prediction1['Label'][0], 
    prediction2['Label'][0], 
    prediction3['Label'][0], 
    prediction4['Label'][0], 
