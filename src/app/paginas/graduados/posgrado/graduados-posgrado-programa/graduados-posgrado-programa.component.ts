...
@Component({
  selector: 'app-graduados-posgrado-programa',
  templateUrl: './graduados-posgrado-programa.component.html',
  styleUrls: ['./graduados-posgrado-programa.component.css']
})
export class GraduadosPosgradoProgramaComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.graduadosPosgradoService.graduados_posgrado_programa(this.graduadoPosgrado).subscribe(
      responseData => {
